...
: ${AMENT_CURRENT_PREFIX:="/home/sv/ros/software/onboard/ros_workspace/install/hardware"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hardware/environment/library_path.sh"
